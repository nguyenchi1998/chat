                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    >
                        <div class="chat" id="chat1">
                            <TopStatus/>
                            <div
                                    class="content ps-container ps-theme-default ps-active-y"
                                    id="content"
                                    data-ps-id="78cb31dd-3794-56c1-eefd-e1106fa301e9"
                                ...
                                <div class="container">
                                    <div class="col-md-12">
                                        <div
                                                ...
                                                class="message"
                                                :class="{me: user._id === message.user}"
                                                :key="message._id"
                                        >
                                            <img
                                                    v-if="user._id !== message.user"
                                                    class="avatar-md"
                                                    src="@/assets/avatar-female-5.jpg"
                                                    data-toggle="tooltip"
                                                    data-placement="top"
                                                    title
                                                    alt="avatar"
                                            />
                                            <div class="text-main">
                                                <div class="text-group" :class="{me: user._id !== message.user}">
                                                    <div class="text" :class="{me: user._id !== message.user}">
                                                        <p>{{message.content}}</p>
                                                    </div>
                                                </div>
                                                <span>{{ new Date(message.createdAt).toLocaleTimeString('en-US', { timeZone: 'Asia/Bangkok' })}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
  import { fetchMessage, getInfoUser } from '@/api';
  import Sidebar from '@/components/Sidebar';
  import TopStatus from '@/components/TopStatus';

  export default {
    name: 'Home',
    components: { TopStatus, Sidebar },
    data: () => {
      return {
        messages: [],
        user: {}
...
<style scoped>
    ...
    @import "../assets/perfect-scrollbar.min.css";
    ...
    ::-webkit-scrollbar-track {
        ...
        -ms-box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.06);
        -o-box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.06);
    ...
    .sidebar .settings .profile .stats {
        ...
        -o-border-radius: 6px;
        border-radius: 6px;
        -webkit-box-shadow: 0 0 20px rgba(157, 184, 209, 0.12);
        -moz-box-shadow: 0 0 20px rgba(157, 184, 209, 0.12);
        -ms-box-shadow: 0 0 20px rgba(157, 184, 209, 0.12);
        -o-box-shadow: 0 0 20px rgba(157, 184, 209, 0.12);
    ...
    .main .chat .content .message .text {
        ...
        -ms-border-radius: 0px 25px 0px 25px;
    ...
    .main .chat .content .no-messages .options .button {
        ...
        -o-border-radius: 100%;
        border-radius: 100%;
        -webkit-box-shadow: 0 5px 10px 4px rgba(0, 0, 0, 0.04) !important;
        -moz-box-shadow: 0 5px 10px 4px rgba(0, 0, 0, 0.04) !important;
        -ms-box-shadow: 0 5px 10px 4px rgba(0, 0, 0, 0.04) !important;
        -o-box-shadow: 0 5px 10px 4px rgba(0, 0, 0, 0.04) !important;
